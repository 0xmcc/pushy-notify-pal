...
export const IPhoneMock: React.FC<IPhoneMockProps> = ({ className = "", isLastStep = false, showCautionTape = false, children }) => {
  return (
    <div
      className={`relative ${showCautionTape ? 'h-[350px]' : 'h-[450px]'} w-[300px] rounded-t-[50px] border-[7px] border-gray-700 overflow-hidden shadow-xl pointer-events-none ${className}`}
      style={{ 
        borderBottom: "none",
